...
import numpy as np
ncas=32
n_elec=30#fockspace=[(5, 4), (3, 3), (5, 4), (3, 3)]
spin=2
...
bond_dims =  [1350] * 16 + [1250]*16+[1000]*16+[800]*16+[600]*16+[500]*16
noises = [0] * 16
thrds = [1e-8] * 16
...
energy = driver.dmrg(mpo, ket, n_sweeps=84, bond_dims=bond_dims, noises=noises,
                     tol=0, thrds=thrds, iprint=1,twosite_to_onesite=82)
